              ...
              {token &&
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li>
                      <NavLink to="/viewprofile" class="dropdown-item" >View Profile</NavLink>
                    </li>
                    <li><hr class="dropdown-divider" /></li>
                    <li>
                      <NavLink to="/updateprofile" class="dropdown-item" >Update Profile</NavLink>
                    </li>
                    <li><hr class="dropdown-divider" /></li>
                    <li>
                      <NavLink to='/changepassword' class="dropdown-item" >Change Password</NavLink>
                    </li>
                    <li><hr class="dropdown-divider" /></li>
                    <li>
